...
<?php 
	if(isset($_SESSION['USER'])){ require_once "view/blog/formRecipe.php"; } 
?>

<div class="m-20"></div>
<div class="flex-center">
	<p class="txt-first font-i-f"><a  style="text-decoration:underline" href="index.php?c=blog">Regresar</a> -> Vista a la receta </p>
</div>
<div class="m-20"></div>
