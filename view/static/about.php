		...
		<main>
			<section class="nosotros flex-center bck-about">
				<div class="picture">
					<img src="assets/img/pictures/about.png" alt="">
				</div>
			...
			<section class="time flex-center flex-y">
				...
				<div class="container">
					<!-- Days --> 
					<div class="box txt-white bck-black-time font-barriecito">
					...
					<!-- Hours -->
					<div class="box txt-white bck-black-time-2 font-barriecito">
