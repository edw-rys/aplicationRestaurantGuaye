    ...
    <div id="message-panel" class="font-p-h message">
        <div class="_head flex-end">
            <span class="flex-end" onclick="panelClose('#message-panel','active','#panelMss')"><i class="fas fa-times"></i></span>
        </div>
        <div id="panelMss"></div>
    </div>
    ...
    <script type="text/javascript" src="assets/js/activeForm.js"></script>
